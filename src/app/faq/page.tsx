   ...
   <div className="min-h-screen max-w-screen-md mx-auto mt-12 p-4">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger className="font-bold text-xl">Who are you folks?</AccordionTrigger>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger className="font-bold text-xl">How is this different from other platforms for creators?</AccordionTrigger>
            <AccordionContent className="font-regular text-lg text-gray-600">
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger className="font-bold text-xl">Who uses Buy Me a Coffee?</AccordionTrigger>
            <AccordionContent className="font-regular text-lg text-gray-600">
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger className="font-bold text-xl">How do I get paid?</AccordionTrigger>
            <AccordionContent className="font-regular text-lg text-gray-600">
          ...
          <AccordionItem value="item-5">
            <AccordionTrigger className="font-bold text-xl">How can my audience pay?</AccordionTrigger>
            <AccordionContent className="font-regular text-lg text-gray-600">
            We support all major credit and debit cards, Apple Pay, Google Pay, Cash App and other global payment methods.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-6">
            <AccordionTrigger className="font-bold text-xl">Is there a fee to use Buy Me a Coffee?</AccordionTrigger>
            <AccordionContent className="font-regular text-lg text-gray-600">
          ...
          <AccordionItem value="item-7">
            <AccordionTrigger className="font-bold text-xl">Is Ek Chai Pilade safe and reliable?</AccordionTrigger>
            <AccordionContent className="font-regular text-lg text-gray-600">
          ...
          <AccordionItem value="item-8">
            <AccordionTrigger className="font-bold text-xl">How do I contact Ek Chai Pilade?</AccordionTrigger>
            <AccordionContent className="font-regular text-lg text-gray-600">
